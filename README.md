...
```
HM26-85FB/
├── resource.md                        # Hackathon landing page & Drive links index
├── ai.md                              # Complete AI architecture & prompt disclosure
├── README.md                          # Root system documentation
├── resource-templates/                # Official hackathon presentation & decision log templates
└── src/
